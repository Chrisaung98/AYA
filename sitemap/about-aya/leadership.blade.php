                        ...
                        <div class="col-md-4 px-3 mb-40">
                            <div class="card h-100 sitemap_card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <a class="theme_text_color" href="{{ url('/about-aya/who-we-are/leadership/message-from-chairman') }}">Explore more <i class="menu-icon tf-icons bx bx-right-arrow-alt"></i></a>
                                    </p>
                                </div>
                            </div>
                        </div>
